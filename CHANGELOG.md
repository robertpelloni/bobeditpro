...
Audacity 3.6 adds a master channel, and a new compressor and limiter. 

 Major changes

   * Master effects
     A new master channel can now be used to apply effects to all tracks at once.
   * New compressor and limiter
     A new compressor and limiter has been added, replacing the previous versions. Both are realtime-capable.
   ...
   * Increased performance
     Audacity is now quite a bit snappier than before, especially when working on larger projects and/or larger screens.
 ...
 Other changes
   ...
   * Made the track header wider and simplified it a bit.
   ...
   * Added an Extra > Export > Export Selected Audio menu item. 
...
Changes in version 3.4.2
 ...
 This is a hotfix release. It fixes the following issues:
   ...
   * #5555 Copy-pasting now pastes into audio again by default. 
     This can be changed via Preferences -> Track Behavior -> Always paste audio as new clips.
