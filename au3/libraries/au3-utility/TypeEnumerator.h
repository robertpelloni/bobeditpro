...
#define BEGIN_TYPE_ENUMERATION(Tag) namespace { \
    struct Tag {}; \
    [[maybe_unused]] inline auto enumerateTypes(Tag, Tag, ...)->TypeEnumerator::detail::Unenumerated { return {}; } }

//! This macro must occur at file scope, not within any other namespace
#define ENUMERATE_TYPE(Tag, T) namespace { [[maybe_unused]] inline auto enumerateTypes( \
